...
import villainsImg from '../assets/villainsbackgrounddarker.jpg';
				...
				{loading ? (
					...
					<FormStyle onSubmit={e => loginUser(e)}>
						{state.userJustRegistered ? (
							<RegisterSuccess>Succesfully Registered! Please Login</RegisterSuccess>
						) : null}
						<h1>Sign into jiujitsio</h1>
						<p>Enter details below</p>
						{state.passwordReset === true ? (
							<ResetText>
								If there's a jiujitsio account linked to this email address, we'll send over
								instructions to reset your password.
							</ResetText>
						) : null}
						{error ? (
							<StyledError>Oops! That email / password combination is not valid.</StyledError>
						) : null}
						<InputContainer>
							<h3>EMAIL ADDRESS</h3>
							<input
...
const SideImage = styled.div`
	...
	background-image: url(${villainsImg});
